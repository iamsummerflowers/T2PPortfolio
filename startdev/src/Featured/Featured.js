            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="order-2 lg:order-1">
                    <div className={`text-8xl mb-6 text-center lg:text-left`}>
                        {/* {featuredProject[0].image} */}
                    </div>
                    <h3 className="text-3xl font-bold text-white mb-4">{featuredProject[0].title}</h3>
                    <p className="text-gray-300 text-lg mb-6 leading-relaxed">
                        {featuredProject[0].description}
                    </p>
                    <div className="flex flex-wrap gap-2 mb-8">
                        {featuredProject[0].tech.map((tech, index) => (
                            <span
                                key={index}
                ...
                <div className="order-1 lg:order-2">
                    <div className={`rounded-2xl p-8 h-80 bg-gradient-to-br ${featuredProject[0].color} flex items-center justify-center border`}
                            style={{
                    ...
                    >
                        <div className="text-center">
                            <div className="text-6xl mb-4">{featuredProject[0].image}</div>
